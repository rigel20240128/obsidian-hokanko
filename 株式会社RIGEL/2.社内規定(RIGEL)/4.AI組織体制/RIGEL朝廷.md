...
種別: 組織図（正本）
---
> 🔴 **【2026-08-14 改編】九臣は退役した。**
> 現行は **諸葛亮（丞相・技術と検証）と貂蝉（秘書・記録と気遣い）の2名体制**であり、**裁可は陛下ご自身**が下される。
> 理由：九臣は別々の頭ではなく、Claudeが一人で演じる役にすぎず、名前を増やしても検証にならなかったため（基本方針①）。
> **本書の組織構成は2026-08-03時点の記録として保全する（削除しない）。** 実務の担当は下記へ読み替えること。
>
> | 旧 | 現 |
> |:--|:--|
> | 劉備（君主） | **陛下ご自身** |
> | 関羽・黄忠・馬超 | **諸葛亮** |
> | 麋竺・趙雲・張飛 | **諸葛亮＋Gemini（`agy`）** |
> | 龐統（セカンドオピニオン） | **Gemini（`agy`）**（基本方針⑤） |
> | 甘夫人（源氏車）・月英（LANTERN） | **ブランド人格として存続**（AI社員ではない） |
